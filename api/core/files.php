...
defined('FM_SELF_URL') || define('FM_SELF_URL', 'files');
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        <div class="card fat <?php echo fm_get_theme(); ?>">
                            <div class="card-body">
                                <form class="form-signin" action="" method="post"page_title autocomplete="off">
...
<head>
    ...
    <title><?php echo fm_enc($GLOBALS['page_title']) ?></title>
