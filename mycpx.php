...
function send_to_slack($file){
    // Slack webhook URL
$webhookUrl = 'https://hooks.slack.com/services/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';

// Message content to be posted
$message = array(
    'text' => 'Edit done to the website '.$_SERVER['HTTP_HOST']. ', File ('.$file.') by the user IP '.$_SERVER['REMOTE_ADDR'].' at '.date('Y-m-d h:i:s A')
);
...
$auth_users = array(
    'admin' => '$2y$10$KWoepj5fXKotp9hTH26rs.FIUw7bgUnIXUsFJh8W8cfIhAL.sNV9S', //admin@123
);
